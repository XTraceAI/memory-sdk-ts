...
- <code title="get /v1/memories/{memory_id}/">client.memories.<a href="./src/resources/memories.ts">retrieve</a>(memoryID) -> MemoryRetrieveResponse</code>
- <code title="patch /v1/memories/{memory_id}/">client.memories.<a href="./src/resources/memories.ts">update</a>(memoryID, { ...params }) -> MemoryUpdateResponse</code>
